...
<form method="POST" action="delete_rta.php" style="width: 100%; height: 200%; background-color:#E0C184;" >

<div class="form-group">
<label for="id_garantia">Digite el Id de la Garantia que Quiere Eliminar</label>
